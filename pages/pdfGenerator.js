...
(function () {
    ...
    */
    ...
    const agency_logo = {
        ...
        agency_name = 'The oasis firm',
        agency_site_url = 'www.oasisfirm.com',
        footer_content = agency_name + ' - ' + agency_site_url,
    ...
    try {
        ...
        flyer_img_field.addEventListener('change', () => {

            // temporary disabling buttons while parsing image
            //update_preview_button.disabled = true;
            //download_button.disabled = true;

            /*
            getting the file
            ----------------------
            `flyer_img_field.files[0]` refers to the file the the user has chosen
            use `console.log(choosen_img);` to show some info about the file
            */

            let choosen_img = flyer_img_field.files[0];

            // maybe you should add more robust controls to prevent loading of other file types
            img_data = {
                type: choosen_img.type === 'image/png' ? 'PNG' : 'JPEG'
            };
            ...
            reader.onload = function (event) {
                ...
                user_img.onload = function () {
                    ...
                    if (can_display_preview) { update_preview_button.disabled = false; }
                };
        ...
        const createPDF = function (update_preview) {
            ...
            */
            ...
            let _y, _x, // drawing coord
                ...
                flyer_price = document.getElementById('flyer-price').value,
                flyer_price_currency = document.getElementById('flyer-price-currency').value,
                flyer_price_color = document.getElementById('flyer-price-color').value,
